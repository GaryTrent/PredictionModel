...
def print_categorical_info(data):
    print("**************************************************")
    print("\n Printing Categorical Variables Information:")
    print("**************************************************")
...
def print_numerical_info(data):
    print("**************************************************")
    print("Printing Numerical Variables Information:")
    print("**************************************************")
    ...
    for col in numerical_cols:
        ...
        print(f"Mean value: {data[col].mean():.2f}")
        print(f"Median value: {data[col].median():.2f}")
        print(f"Standard deviation: {data[col].std():.2f}")
        print("Value distribution (top 5 most frequent):")
        print(data[col].value_counts(normalize=True).head())
        print("-" * 50)
